export default function SignupLoading() {
  return (
    <div className="flex min-h-screen">
      {/* Left panel skeleton */}
      <div className="hidden lg:flex lg:w-[45%] flex-col justify-between overflow-hidden bg-brand-blue p-12">
      ...
      <div className="flex flex-1 flex-col items-center justify-center bg-slate-50 px-6 py-12">
        <div className="w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-[0_8px_40px_rgba(11,28,61,0.12)]">
          ...
          <div className="animate-pulse px-8 py-8">
            ...
            <div className="mx-auto mb-6 h-4 w-56 rounded bg-slate-100" />
