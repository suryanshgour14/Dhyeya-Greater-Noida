...
const COLOR = {
  ...
  gold: {
    hero: "from-amber-950 via-amber-900 to-slate-900",
    badge: "bg-amber-100 text-amber-800",
    tab: "text-amber-700 border-amber-600",
    tabInactive: "hover:text-amber-700",
    accent: "bg-amber-600",
  ...
  orange: {
    hero: "from-orange-950 via-orange-900 to-slate-900",
    badge: "bg-orange-100 text-orange-800",
    tab: "text-orange-700 border-orange-600",
    tabInactive: "hover:text-orange-700",
  ...
  green: {
    hero: "from-green-950 via-green-900 to-slate-900",
    badge: "bg-green-100 text-green-800",
    tab: "text-green-700 border-green-600",
    tabInactive: "hover:text-green-700",
    accent: "bg-green-600",
