  ...
  return (
    <section className="relative min-h-[92vh] overflow-hidden bg-brand-blue">
      ...
      <div className="container relative mx-auto grid min-h-[92vh] items-center gap-12 px-4 py-16 lg:grid-cols-2 lg:gap-16">
        ...
        {/* ── Left column — pure CSS animations, no Framer Motion opacity:0 ── */}
        <div className="flex flex-col items-start">

          {/* Badge */}
          <div className="hero-animate hero-animate-d0 mb-5">
          ...
          {/* Heading */}
          <h1 className="hero-animate hero-animate-d80 mb-5 text-4xl font-bold leading-[1.12] tracking-tight text-white sm:text-5xl lg:text-[3.4rem]">
            {t("hero.title")}
          </h1>

          {/* Subtitle — LCP element: CSS animation starts on first paint, no JS wait */}
          <p className="hero-animate hero-animate-d150 mb-7 max-w-xl text-base leading-relaxed text-slate-300 sm:text-lg">
            {t("hero.subtitle")}
          </p>

          {/* Feature pills */}
          <div className="hero-animate hero-animate-d220 mb-8 flex flex-wrap gap-2">
            {HERO_FEATURES.map((f) => (
              <span
                key={f}
          ...
          {/* CTAs */}
          <div className="hero-animate hero-animate-d280 flex flex-wrap items-center gap-3">
            <Button
              asChild
              size="lg"
          ...
          {/* Trust strip */}
          <p className="hero-animate hero-animate-d350 mt-7 text-xs text-slate-400">
            {t("hero.trustLine")}
          </p>
        </div>

        {/* ── Right column — Framer Motion carousel (interactive, not LCP) ── */}
        <motion.div
